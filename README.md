...
- **Sem curtida, sem contador de seguidores, sem ofensiva (streak).** Nada em volta da sua LEITURA é contado: nem resenha, nem quem te segue, nem quem leu o quê. A única contagem de gente no app é quantas pessoas guardaram uma coleção, e ela é sobre curadoria, não sobre você. E sem placar: existe uma **honra** no seu perfil, e **não existe lista de quem leu mais**. Uma lista ordenada por leitura é uma máquina de fazer gente mentir que leu.
