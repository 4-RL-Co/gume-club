...
- **No likes, no follower count, no streak.** And no leaderboard: there is an **honor** on your profile, and there is **no list of who read the most**. A list ranked by reading is a machine for making people lie about what they read.
